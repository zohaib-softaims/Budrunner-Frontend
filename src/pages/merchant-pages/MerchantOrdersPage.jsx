...
import { merchantOrderData } from "../../contants/merchantData";
  ...
  return (
    <div className="ml-72 min-h-screen bg-gray-50 p-4 lg:p-8">
      <div className="mb-6 lg:mb-8">
        ...
        <p className="text-gray-600 mt-1">Track your orders and approve returns in real time</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div className=" overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {merchantOrderData?.map((order, index) => (
        ...
        <div className="px-4 lg:px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="px-3 py-1 text-gray-400 hidden sm:inline">...</span>
